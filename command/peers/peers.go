...
import (
	...
	"github.com/vishnushankarsg/metad/command/peers/add"
	"github.com/vishnushankarsg/metad/command/peers/list"
	"github.com/vishnushankarsg/metad/command/peers/status"
